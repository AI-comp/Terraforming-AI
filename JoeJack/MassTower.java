...
public class MassTower {
	final static int DistanceBetweenHouseAndMyInitial = 5;
	final static int NumRobotsToDefendConstruction = 1;
	final static int NumPointsToBuildHousesAtOnce = 2;
	Random random;

	public static void main(String[] args) {
		MassTower ai = new MassTower();
		ai.run();
	}
	...
	private void run() {
		...
		System.out.println("JoeJack MassTower");
